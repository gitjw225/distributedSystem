...
public class SkiersApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call writeNewLiftRideCall(LiftRide body, Integer resortID,
        String seasonID, String dayID, Integer skierID, final ProgressResponseBody.ProgressListener progressListener,
